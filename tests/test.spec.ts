				...
				"categories": [
					{
						"features": [
							...
							},
							{
								"category": "Clinical History",
								"default": 0,
								"description": "Patient has a history of coronary artery disease or ischaemic heart disease, treated or otherwise, including prior coronary artery bypass surgery or coronary angioplasty.\nAcute coronary syndromes or coronary artery bypass surgery directly related or associated with the patients current presentation are also included.",
							...
							},
							{
								"category": "Clinical History",
								"default": 0,
								"description": "History, clinical and radiological features of chronic respiratory disease, such as chronic obstructive pulmonary disease, emphysema, asthma, interstitial lung disease, cystic fibrosis and bronchiectasis.\n\nExclusions: Sleep apnoea, lung cancer and neurological causes for respiratory compromise.",
							...
							},
							{
								"category": "Clinical History",
								"default": 0,
								"description": "Where ECLS was initiated immediately following or in the post-operative period following lung transplantation.\nThis includes cases of single lung transplant or combination heart and lung transplant.",
							...
							},
							{
								"category": "Clinical History",
								"default": 0,
								"description": "Pulmonary embolism diagnosed with CT pulmonary angiogram, ventilation perfusion scan (V/Q) or contrast pulmonary angiography.",
							...
							},
							{
								"category": "Clinical History",
								"default": 0,
								"description": "Select 'Yes' if the patient received intravenous bicarbonate within the 24 hours prior to the ECLS start time, administered as an infusion or as a bolus for metabolic acidosis.",
					...
					},
					{
						"features": [
							...
							},
							{
								"category": "Hemodynamics",
								"default": 12,
								"description": "Select a respiratory rate if the patient was mechanically ventilated with either conventional or high frequency oscillatory ventilation.\n\nRespiratory rate units of measure is breaths per minute (bpm).  A respiratory rate between 0 and 90 bpm can be selected.",
							...
							},
							{
								"category": "Hemodynamics",
								"default": 47,
								"description": "The arterial partial pressure of carbon dioxide (PaCO2) is based on an arterial blood gas drawn prior to, and no more than 6 hours before, the ECLS start time.\nIf multiple arterial blood gases exist in this time period, choose the pre-ECLS blood gas closest to AND before the ECLS start time.\n\nIf this information is unknown or unavailable, keep the default value of '47'.\n\nA PaCO2 between 15 mmHg and 200 mmHg can be entered.",
								"label": "PaCO₂ (mmHg)",
								"max": 200,
								"min": 15,
								"name": "PCO2",
